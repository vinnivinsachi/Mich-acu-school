	...
	*/
	...
	{	
		...
		*/
				...
				case 'submit':
					...
					if(strlen($username)==0){
						...
						if($user->load($username, 'username')){
							$user->fetchPassword();
							//echo 'here at ater user->fetchPassword';
		...
		public function applyforpromotioncodeAction(){	
			$request= $this->getRequest();
			...
			$promotionApplication = new FormProcessor_PromotionRequest($this->db, $this->signedInUserSessionInfoHolder->generalInfo->userID);
		...
		public function applicationsendAction(){
			
		}
		
		public function applicationalreadysentAction(){
