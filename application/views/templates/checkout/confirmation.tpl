...
<div id="rightContainer" style='width:750px; float:left;'>
	...
	<div id="orderMainDiv" style="float:left; width:100%;">
        ...
        <div id="orderShippingDetails" style="width:100%; float:left; margin-top:15px;">
                ...
                <div id="finalUserOrderShippingInfo" style="margin-left:45px; padding:10px; margin:0px; font-weight:bold; font-size:14pt; line-height:1.3em;">
                ...
                <a href="{geturl action='index'}"><img src="/public/resources/css/images/backToShipping.gif" /></a><br />
        </div>
        ...
        <div id="orderRewardsDetails" style="width:100%; float:left;margin-top:15px;">
            ...
            <div id="orderRewardMotherDiv" style="width:730px; float:left; padding:10px; border-bottom:1px solid #069;">
                ...
                <div id="orderPromotionsMotherDiv" style="width:730px; float:left; padding:10px;">
                    ...
                    <div id="promotionInputTitle" style="width:50%; float:left;">
                   	 Promotion code used: 
                   	 					<input class='inputShiftOne' type="text" value="{$shoppingCartInfo->promotionCodeUsed}" readonly="readonly"/>                    
           ...
           <a href="{geturl action='index'}"><img src="/public/resources/css/images/backToRewardPoint.gif" style="margin-left:-3px;"/></a>
        ...
        <a href="{geturl action='createorder'}" style="float:right;"><img src="/public/resources/css/images/next to paypal.gif" style="margin-bottom:-1px;"/></a>
    </div>
</div>
